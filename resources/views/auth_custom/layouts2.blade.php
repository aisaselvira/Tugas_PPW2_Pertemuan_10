...
<html lang="en"> 
    ...
    <body>
    <nav class="navbar navbar-expand-lg bg-light"> <div class="container"> <a href="{{URL('/')}}" class="navbar-brand">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <li class="nav-item">
                <a href="{{route('register2')}}" class="nav-link {{(request()->is('register2')) ?
                'active':''}}">Register</a>
                </li>
                @else
                <li class="nav-item">
                <a href="{{route('dashboard2')}}" class="nav-link {{(request()->is('dashboard2')) ?
                'active':''}}">Dashboard</a>
            </li>
            <li class="nav-item">
            ...
            <li><a class="dropdown-item" href="{{ route('logout2') }}" onclick="event.preventDefault();
